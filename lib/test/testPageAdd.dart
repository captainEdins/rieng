...
class TestPageAdd extends StatefulWidget {
  final bool isEditable;
  TaskNew? taskNew;

  TestPageAdd({super.key, this.isEditable = false, this.taskNew});

  @override
  State<TestPageAdd> createState() => _TestPageAddState();
}

class _TestPageAddState extends State<TestPageAdd> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            Text(
              widget.isEditable ? "Edit Habit" : "Add Habit",
  ...
  void addStaticData() {
    setState(() {
      ...
      getReminder.text = "${widget.taskNew!.remind!.toString()} minutes early";
